...
function exportAllSeoData() {
  ...
  try {
    ...
    csvContent += `Meta,Title Length,${titleLen} chars,${titleStatus},${escape(titleRec)}\n`;
    ...
    csvContent += `Meta,Description Length,${descLen} chars,${descStatus},${escape(descRec)}\n`;
    ...
    csvContent += `Title,${escape(data.title)}\n`;
    csvContent += `Description,${escape(data.description || '')}\n`;
